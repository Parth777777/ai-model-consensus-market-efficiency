...
4. **Execution Frictions & Sensitivity ($A_4$)**: Baseline returns are reported gross of transaction fees, slippage, and borrow costs. To reflect real-world trading conditions, [Appendix H](file:///c:/Users/parth/OneDrive/Desktop/EMH%20FOLDER%20FEC/report.md#appendix-h-methodological-sensitivity-analysis-matrix) provides a complete transaction cost sensitivity matrix across fees from 10 bps to 100 bps.
...
4. **Execution Frictions and Liquidity**: Baseline returns are reported gross of transaction fees and borrow costs. As demonstrated in [Appendix H](file:///c:/Users/parth/OneDrive/Desktop/EMH%20FOLDER%20FEC/report.md#appendix-h-methodological-sensitivity-analysis-matrix), execution frictions of 25 bps eliminate the large-cap spread, while the small-cap spread remains positive up to 50 bps.
