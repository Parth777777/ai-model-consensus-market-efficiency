...
> **Direct Document Downloads:** [📄 Executive Report (PDF)](report.pdf) • [📝 Executive Report (DOCX)](report.docx) • [🌐 Web Interactive (HTML)](report.html) • [📚 Technical Appendices A–H](technical_appendices.md) • [📖 Annotated Bibliography](references.md)
